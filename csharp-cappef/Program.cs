...
using (SchoolContext db = new SchoolContext())
{
    ...
    Student nuovoStudente =
        new Student { Name = "Francesco", Surname = "Totti", Email="francescototti@gmail.it"};
...
public class SchoolContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=PrimoDatabase;Integrated Security=True;Pooling=False");
    }
}